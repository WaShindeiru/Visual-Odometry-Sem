...
if __name__ == "__main__":
   path = "/home/washindeiru/studia/7_semestr/vo/visual_odometry/LightGlue/results/kitty_06+2025-05-31_22:46:49"

   evaluate_placeholder(path, threshold=None, save_error=True, save_error_path="lightglue.txt", log=False)
